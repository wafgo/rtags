...
- Get the code
  ...
  RTags releases are available for download under the [[https://github.com/Andersbakken/rtags/releases][releases]] page. Releases
  prior to version 2.21 DO NOT contain the submodules. Versions 2.14 through
  2.20 can be downloaded from https://github.com/Andersbakken/rtags-releases.
